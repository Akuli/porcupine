...
class Misc:
    ...
    def event_add(self, virtual: str, __first: str, *rest: str) -> None: ...
...
class BaseWidget(Misc):
    ...
    def winfo_exists(self) -> bool: ...  # actually 0 or 1
    def winfo_ismapped(self) -> bool: ...  # actually 0 or 1
...
class Menu(Widget):
    def __init__(self, master: Optional[Misc] = ..., *, tearoff: bool = ...) -> None: ...
    def entryconfig(
    ...
    def add_radiobutton(
        self, *, label: str = ..., accelerator: str = ...,
        variable: StringVar = ..., value: str = ...,
        foreground: str = ..., background: str = ...,
        activeforeground: str = ..., activebackground: str = ...,
    ) -> None: ...
    def add_separator(self) -> None: ...
    def type(self, index: _MenuIndex) -> Literal['command', 'separator', 'checkbutton', 'radiobutton', 'cascade', 'tearoff']: ...
    def entrycget(self, index: _MenuIndex, option: Literal['menu', 'label']) -> Any: ...
...
class Text(Widget, XView, YView):
    ...
    def __getitem__(self, opt: Literal['font', 'xscrollcommand', 'yscrollcommand', 'state', 'fg', 'bg']) -> Any: ...
    ...
    def tag_delete(self, __tag1: str, *other_tags: str) -> None: ...
    def tag_lower(self, tagName: str, belowThis: str = ...) -> None: ...
    def tag_names(self, index: Optional[str] = None) -> Tuple[str, ...]: ...
...
class Wm:
    ...
    def attributes(self, __opt: Literal['-fullscreen'], __val: bool) -> None: ...  # actually returns empty string
...
class Tk(BaseWidget, Wm):
    ...
    def __getitem__(self, opt: Literal['menu']) -> Any: ...
