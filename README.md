...
Open a terminal and run these commands:
    ...
    python3 -m pip install https://github.com/Akuli/porcupine/archive/v0.96.0.zip
    python3 -m porcupine
...
No. Porcupine is indeed meant to be a serious editor, in fact you might regret even touching it.
